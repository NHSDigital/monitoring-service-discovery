...
![Build](https://github.com/NHSDigital/monitoring-service-discovery/workflows/Build/badge.svg?branch=master)
...
## Contributing
Contributions to this project are welcome from anyone, providing that they conform to the [guidelines for contribution](https://github.com/NHSDigital/monitoring-service-discovery/blob/master/CONTRIBUTING.md) and the [community code of conduct](https://github.com/NHSDigital/monitoring-service-discovery/blob/master/CODE_OF_CONDUCT.md).
...
Successful deployment of the API Proxy requires:
 ...
 1. A *Target Server* named `monitoring-service-discovery-target`
 2. A *Key-Value Map* named `msd-variables`, containing any values you might need at proxy runtime
 2. A *Key-Value Map* named `msd-variables-encrypted`, containing any secrets you might need at proxy runtime
